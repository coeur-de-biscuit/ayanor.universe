export const worldRegions = [
  {
    ...
    name: "Arles",
    type: "Continente",
    mood: "Vinhas douradas, cortes antigas e magia herdada",
    summary:
      "Arles e um continente de beleza quase insolente: cidades floridas, palacios de pedra clara, vinhedos sem fim e uma aristocracia que ainda mede prestigio por sangue, arte e segredos. Por baixo da elegancia, a heranca elfica moldou leis, nomes, jardins e rivalidades que atravessam seculos.",
    history:
  ...
  },
  {
    ...
    name: "Ayanor",
    type: "Regiao arcana",
    mood: "Torres antigas, academias e memoria magica",
    summary:
      "Ayanor concentra escolas arcanas, torres errantes e bibliotecas que parecem lembrar mais do mundo do que seus habitantes.",
    history:
